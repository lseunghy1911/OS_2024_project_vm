 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 28 09 00 00 	movzbl 0x928(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb 21 09 00 00       	mov    $0x921,%ebx
        while(*s != 0){
...
print_free_list(){
 ...
 604:	83 ec 0c             	sub    $0xc,%esp
  Header* p;
  printf(1, "Header -> ");
 607:	68 39 09 00 00       	push   $0x939
 60c:	6a 01                	push   $0x1
 60e:	e8 1d fe ff ff       	call   430 <printf>
  if(freep == 0){ 
 613:	a1 80 0c 00 00       	mov    0xc80,%eax
...
free(void *ap)
{
 ...
 671:	a1 80 0c 00 00       	mov    0xc80,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 80 0c 00 00       	mov    %eax,0xc80
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 80 0c 00 00       	mov    %eax,0xc80
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 733:	e8 38 ff ff ff       	call   670 <free>
  return freep;
 738:	a1 80 0c 00 00       	mov    0xc80,%eax
}
...
malloc(uint nbytes)
{
 750:	55                   	push   %ebp
  ...
  if((prevp = freep) == 0){
 751:	8b 0d 80 0c 00 00    	mov    0xc80,%ecx
{
 ...
 75a:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 789:	8b 0d 80 0c 00 00    	mov    0xc80,%ecx
 ...
 7bf:	5b                   	pop    %ebx
      freep = prevp;
 7c0:	a3 80 0c 00 00       	mov    %eax,0xc80
      return (void*)(p + 1);
 ...
 7cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 80 0c 00 00 84 	movl   $0xc84,0xc80
 7d7:	0c 00 00 
    base.s.size = 0;
 7da:	b9 84 0c 00 00       	mov    $0xc84,%ecx
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 84 0c 00 00 84 	movl   $0xc84,0xc84
 7e6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 c8                	mov    %ecx,%eax
    base.s.size = 0;
 7eb:	c7 05 88 0c 00 00 00 	movl   $0x0,0xc88
 7f2:	00 00 00 
    if(p->s.size >= nunits){
...
malloc_wf(uint nbytes)
{
 ...
 829:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((prevp = freep) == 0){
 830:	8b 1d 80 0c 00 00    	mov    0xc80,%ebx
 ...
 89c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 8a0:	c7 05 80 0c 00 00 84 	movl   $0xc84,0xc80
 8a7:	0c 00 00 
 8aa:	c7 05 84 0c 00 00 84 	movl   $0xc84,0xc84
 8b1:	0c 00 00 
    base.s.size = 0;
 8b4:	c7 05 88 0c 00 00 00 	movl   $0x0,0xc88
 8bb:	00 00 00 
  if(maxp != 0){
 ...
 8d9:	89 43 04             	mov    %eax,0x4(%ebx)
    freep = prevp;
 8dc:	89 3d 80 0c 00 00    	mov    %edi,0xc80
