...
fork1(void)
{
  ...
  exit();
      ...
      9d:	68 e0 1a 00 00       	push   $0x1ae0
      a2:	e8 b9 0a 00 00       	call   b60 <strlen>
      if(chdir(buf+3) < 0)
      a7:	c7 04 24 e3 1a 00 00 	movl   $0x1ae3,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      ae:	c6 80 df 1a 00 00 00 	movb   $0x0,0x1adf(%eax)
      if(chdir(buf+3) < 0)
      ...
      c1:	50                   	push   %eax
      c2:	68 e3 1a 00 00       	push   $0x1ae3
      c7:	68 fd 13 00 00       	push   $0x13fd
      cc:	6a 02                	push   $0x2
...
00000110 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     11e:	68 54 13 00 00       	push   $0x1354
     123:	6a 02                	push   $0x2
...
00000160 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	68 f1 13 00 00       	push   $0x13f1
     16e:	6a 02                	push   $0x2
...
00000180 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 0c 14 00 00 	jmp    *0x140c(,%eax,4)
    if(pipe(p) < 0)
  ...
  if(pid == -1)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     23a:	68 5e 13 00 00       	push   $0x135e
     23f:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     2bc:	68 83 13 00 00       	push   $0x1383
    ...
    panic("fork");
     ...
     325:	68 7e 13 00 00       	push   $0x137e
...
00000330 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     345:	68 7e 13 00 00       	push   $0x137e
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     357:	6a 54                	push   $0x54
     359:	e8 52 0e 00 00       	call   11b0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     387:	6a 18                	push   $0x18
     389:	e8 22 0e 00 00       	call   11b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3d7:	6a 0c                	push   $0xc
     3d9:	e8 d2 0d 00 00       	call   11b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     417:	6a 0c                	push   $0xc
     419:	e8 92 0d 00 00       	call   11b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     457:	6a 08                	push   $0x8
     459:	e8 52 0d 00 00       	call   11b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     489:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ad:	50                   	push   %eax
     4ae:	68 bc 1a 00 00       	push   $0x1abc
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fd:	50                   	push   %eax
     4fe:	68 bc 1a 00 00       	push   $0x1abc
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     53e:	50                   	push   %eax
     53f:	68 b4 1a 00 00       	push   $0x1ab4
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     560:	56                   	push   %esi
     561:	68 bc 1a 00 00       	push   $0x1abc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 bc 1a 00 00       	push   $0x1abc
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 a5 13 00 00       	push   $0x13a5
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  return cmd;
     ...
     6fe:	68 88 13 00 00       	push   $0x1388
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     71f:	68 a8 13 00 00       	push   $0x13a8
     724:	57                   	push   %edi
     725:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     76e:	68 bf 13 00 00       	push   $0x13bf
     773:	57                   	push   %edi
     774:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7b8:	68 b1 13 00 00       	push   $0x13b1
  ...
  cmd->eargv[argc] = 0;
     ...
     80a:	68 aa 13 00 00       	push   $0x13aa
...
00000820 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     839:	68 c4 13 00 00       	push   $0x13c4
  cmd = parseexec(ps, es);
...
00000890 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 c6 13 00 00       	push   $0x13c6
     8d0:	57                   	push   %edi
     8d1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 c2 13 00 00       	push   $0x13c2
     8e6:	57                   	push   %edi
     8e7:	56                   	push   %esi
...
00000930 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     93f:	68 a8 13 00 00       	push   $0x13a8
     944:	56                   	push   %esi
     945:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     969:	68 e4 13 00 00       	push   $0x13e4
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d9:	ff 24 85 24 14 00 00 	jmp    *0x1424(,%eax,4)
...
00000a70 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a97:	68 65 14 00 00       	push   $0x1465
     a9c:	53                   	push   %ebx
     a9d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     abf:	52                   	push   %edx
     ac0:	50                   	push   %eax
     ac1:	68 e6 13 00 00       	push   $0x13e6
     ac6:	6a 02                	push   $0x2
     ac8:	e8 c3 03 00 00       	call   e90 <printf>
    panic("syntax");
     acd:	c7 04 24 aa 13 00 00 	movl   $0x13aa,(%esp)
     ...
     dec:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e19:	0f b6 92 44 14 00 00 	movzbl 0x1444(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1014:	eb 1a                	jmp    1030 <printf+0x1a0>
          s = "(null)";
    1016:	bb 3c 14 00 00       	mov    $0x143c,%ebx
        while(*s != 0){
...
print_free_list(){
  ...
  Header* p;
  printf(1, "Header -> ");
    1067:	68 55 14 00 00       	push   $0x1455
    106c:	6a 01                	push   $0x1
    106e:	e8 1d fe ff ff       	call   e90 <printf>
  if(freep == 0){ 
    1073:	a1 44 1b 00 00       	mov    0x1b44,%eax
    1078:	83 c4 10             	add    $0x10,%esp
    107b:	85 c0                	test   %eax,%eax
    107d:	74 30                	je     10af <print_free_list+0x4f>
    printf(1, "NULL\n");
    return;
  }
  for(p = base.s.ptr; p != &base; p = p->s.ptr){
    107f:	8b 1d 48 1b 00 00    	mov    0x1b48,%ebx
    1085:	81 fb 48 1b 00 00    	cmp    $0x1b48,%ebx
    108b:	74 22                	je     10af <print_free_list+0x4f>
    108d:	8d 76 00             	lea    0x0(%esi),%esi
    printf(1, "%d -> ", p->s.size);
    1090:	83 ec 04             	sub    $0x4,%esp
    1093:	ff 73 04             	pushl  0x4(%ebx)
    1096:	68 66 14 00 00       	push   $0x1466
    109b:	6a 01                	push   $0x1
    109d:	e8 ee fd ff ff       	call   e90 <printf>
  for(p = base.s.ptr; p != &base; p = p->s.ptr){
    10a2:	8b 1b                	mov    (%ebx),%ebx
    10a4:	83 c4 10             	add    $0x10,%esp
    10a7:	81 fb 48 1b 00 00    	cmp    $0x1b48,%ebx
    10ad:	75 e1                	jne    1090 <print_free_list+0x30>
    printf(1, "NULL\n");
    10af:	83 ec 08             	sub    $0x8,%esp
    10b2:	68 60 14 00 00       	push   $0x1460
    10b7:	6a 01                	push   $0x1
    10b9:	e8 d2 fd ff ff       	call   e90 <printf>
  }
  printf(1, "NULL\n");
}
    ...
    10c1:	c9                   	leave  
    10c2:	c3                   	ret    
    10c3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10d1:	a1 44 1b 00 00       	mov    0x1b44,%eax
{
    ...
    10de:	8b 10                	mov    (%eax),%edx
  bp = (Header*)ap - 1;
    10e0:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10e3:	39 c8                	cmp    %ecx,%eax
    10e5:	73 19                	jae    1100 <free+0x30>
    ...
    10f6:	73 10                	jae    1108 <free+0x38>
{
  ...
  freep = p;
    ...
    1121:	5b                   	pop    %ebx
  freep = p;
    1122:	a3 44 1b 00 00       	mov    %eax,0x1b44
}
    1127:	5e                   	pop    %esi
    1128:	5f                   	pop    %edi
    1129:	5d                   	pop    %ebp
  ...
  freep = p;
    114a:	a3 44 1b 00 00       	mov    %eax,0x1b44
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
    ...
    1163:	53                   	push   %ebx
    1164:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1169:	83 ec 10             	sub    $0x10,%esp
    116c:	3d 00 10 00 00       	cmp    $0x1000,%eax
    1171:	0f 43 d8             	cmovae %eax,%ebx
  char *p;
  Header *hp;
  ...
  p = sbrk(nu * sizeof(Header));
    1174:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    117b:	50                   	push   %eax
    117c:	e8 3a fc ff ff       	call   dbb <sbrk>
  if(p == (char*)-1)
    1181:	83 c4 10             	add    $0x10,%esp
    1184:	83 f8 ff             	cmp    $0xffffffff,%eax
    1187:	74 1f                	je     11a8 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    1189:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    118c:	83 ec 0c             	sub    $0xc,%esp
    118f:	83 c0 08             	add    $0x8,%eax
    1192:	50                   	push   %eax
    1193:	e8 38 ff ff ff       	call   10d0 <free>
  return freep;
    1198:	a1 44 1b 00 00       	mov    0x1b44,%eax
}
    119d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  return freep;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11b1:	8b 0d 44 1b 00 00    	mov    0x1b44,%ecx
{
    ...
    11ba:	8b 45 08             	mov    0x8(%ebp),%eax
{
    11bd:	53                   	push   %ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    11be:	8d 58 07             	lea    0x7(%eax),%ebx
    11c1:	c1 eb 03             	shr    $0x3,%ebx
    11c4:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    11c7:	85 c9                	test   %ecx,%ecx
    11c9:	74 65                	je     1230 <malloc+0x80>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11cb:	8b 01                	mov    (%ecx),%eax
    if(p->s.size >= nunits){
    11cd:	8b 50 04             	mov    0x4(%eax),%edx
    11d0:	39 d3                	cmp    %edx,%ebx
    11d2:	77 1d                	ja     11f1 <malloc+0x41>
    11d4:	eb 2e                	jmp    1204 <malloc+0x54>
    11d6:	8d 76 00             	lea    0x0(%esi),%esi
    11d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11e0:	8b 30                	mov    (%eax),%esi
    if(p->s.size >= nunits){
    11e2:	8b 56 04             	mov    0x4(%esi),%edx
    11e5:	39 da                	cmp    %ebx,%edx
    11e7:	73 27                	jae    1210 <malloc+0x60>
    11e9:	8b 0d 44 1b 00 00    	mov    0x1b44,%ecx
    ...
    if(p == freep)
    11f1:	39 c1                	cmp    %eax,%ecx
    11f3:	75 eb                	jne    11e0 <malloc+0x30>
      if((p = morecore(nunits)) == 0)
    11f5:	89 d8                	mov    %ebx,%eax
    11f7:	e8 64 ff ff ff       	call   1160 <morecore>
    11fc:	85 c0                	test   %eax,%eax
    11fe:	75 e0                	jne    11e0 <malloc+0x30>
        return 0;
  }
}
    1200:	5b                   	pop    %ebx
    ...
    1209:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    1210:	39 d3                	cmp    %edx,%ebx
    1212:	74 4c                	je     1260 <malloc+0xb0>
        p->s.size -= nunits;
    1214:	29 da                	sub    %ebx,%edx
    1216:	89 56 04             	mov    %edx,0x4(%esi)
        p += p->s.size;
    1219:	8d 34 d6             	lea    (%esi,%edx,8),%esi
        p->s.size = nunits;
    121c:	89 5e 04             	mov    %ebx,0x4(%esi)
}
    121f:	5b                   	pop    %ebx
      freep = prevp;
    1220:	a3 44 1b 00 00       	mov    %eax,0x1b44
      return (void*)(p + 1);
    1225:	8d 46 08             	lea    0x8(%esi),%eax
}
    1228:	5e                   	pop    %esi
    1229:	5d                   	pop    %ebp
    122a:	c3                   	ret    
    ...
    base.s.ptr = freep = prevp = &base;
    1230:	c7 05 44 1b 00 00 48 	movl   $0x1b48,0x1b44
    1237:	1b 00 00 
    base.s.size = 0;
    123a:	b9 48 1b 00 00       	mov    $0x1b48,%ecx
    base.s.ptr = freep = prevp = &base;
    123f:	c7 05 48 1b 00 00 48 	movl   $0x1b48,0x1b48
    1246:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1249:	89 c8                	mov    %ecx,%eax
    base.s.size = 0;
    124b:	c7 05 4c 1b 00 00 00 	movl   $0x0,0x1b4c
    1252:	00 00 00 
    if(p->s.size >= nunits){
    1255:	eb 9a                	jmp    11f1 <malloc+0x41>
    1257:	89 f6                	mov    %esi,%esi
    1259:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        prevp->s.ptr = p->s.ptr;
    1260:	8b 16                	mov    (%esi),%edx
    1262:	89 10                	mov    %edx,(%eax)
    1264:	eb b9                	jmp    121f <malloc+0x6f>
...
malloc_wf(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1290:	8b 1d 44 1b 00 00    	mov    0x1b44,%ebx
    1296:	85 db                	test   %ebx,%ebx
    1298:	74 66                	je     1300 <malloc_wf+0x90>
    129a:	8b 03                	mov    (%ebx),%eax
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  ...
  maxp = 0;
  maxprevp = 0;
    129c:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  if((prevp = freep) == 0){
  ...
  maxp = 0;
    ...
    12ae:	8b 50 04             	mov    0x4(%eax),%edx
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12b1:	eb 12                	jmp    12c5 <malloc_wf+0x55>
    12b3:	90                   	nop
    ...
    if(p == freep)
    12b8:	39 d8                	cmp    %ebx,%eax
    12ba:	74 24                	je     12e0 <malloc_wf+0x70>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12bc:	8b 08                	mov    (%eax),%ecx
    if(p->s.size >= nunits && p->s.size > max){
    12be:	89 c7                	mov    %eax,%edi
    12c0:	8b 51 04             	mov    0x4(%ecx),%edx
    12c3:	89 c8                	mov    %ecx,%eax
    12c5:	39 d6                	cmp    %edx,%esi
    12c7:	73 ef                	jae    12b8 <malloc_wf+0x48>
    12c9:	39 55 e4             	cmp    %edx,-0x1c(%ebp)
    12cc:	77 ea                	ja     12b8 <malloc_wf+0x48>
    if(p == freep)
    12ce:	39 d8                	cmp    %ebx,%eax
    12d0:	74 57                	je     1329 <malloc_wf+0xb9>
    12d2:	89 7d dc             	mov    %edi,-0x24(%ebp)
    12d5:	89 d6                	mov    %edx,%esi
    12d7:	89 45 e0             	mov    %eax,-0x20(%ebp)
    12da:	eb e0                	jmp    12bc <malloc_wf+0x4c>
    12dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      break;
  }

  if(maxp != 0){
    12e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
    12e3:	85 c0                	test   %eax,%eax
    12e5:	75 39                	jne    1320 <malloc_wf+0xb0>
      p->s.size = nunits;
    }
    freep = prevp;
    return (void*)(p + 1);
    ...
    12ea:	e8 71 fe ff ff       	call   1160 <morecore>
    12ef:	85 c0                	test   %eax,%eax
    12f1:	75 9d                	jne    1290 <malloc_wf+0x20>
      return 0;
    return malloc_wf(nbytes);
  }
    12f3:	83 c4 1c             	add    $0x1c,%esp
    12f6:	5b                   	pop    %ebx
    12f7:	5e                   	pop    %esi
    12f8:	5f                   	pop    %edi
    12f9:	5d                   	pop    %ebp
    ...
    base.s.ptr = freep = prevp = &base;
    1300:	c7 05 44 1b 00 00 48 	movl   $0x1b48,0x1b44
    1307:	1b 00 00 
    130a:	c7 05 48 1b 00 00 48 	movl   $0x1b48,0x1b48
    1311:	1b 00 00 
    base.s.size = 0;
    1314:	c7 05 4c 1b 00 00 00 	movl   $0x0,0x1b4c
    131b:	00 00 00 
  if(maxp != 0){
    131e:	eb c7                	jmp    12e7 <malloc_wf+0x77>
    1320:	8b 5d e0             	mov    -0x20(%ebp),%ebx
    1323:	8b 7d dc             	mov    -0x24(%ebp),%edi
    1326:	8b 53 04             	mov    0x4(%ebx),%edx
    if(p->s.size == nunits){
    1329:	39 55 e4             	cmp    %edx,-0x1c(%ebp)
    132c:	74 1f                	je     134d <malloc_wf+0xdd>
      p->s.size -= nunits;
    132e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1331:	29 c2                	sub    %eax,%edx
    1333:	89 53 04             	mov    %edx,0x4(%ebx)
      p = p + p->s.size;
    1336:	8d 1c d3             	lea    (%ebx,%edx,8),%ebx
      p->s.size = nunits;
    1339:	89 43 04             	mov    %eax,0x4(%ebx)
    freep = prevp;
    133c:	89 3d 44 1b 00 00    	mov    %edi,0x1b44
    1342:	83 c4 1c             	add    $0x1c,%esp
    return (void*)(p + 1);
    1345:	8d 43 08             	lea    0x8(%ebx),%eax
    1348:	5b                   	pop    %ebx
    1349:	5e                   	pop    %esi
    134a:	5f                   	pop    %edi
    134b:	5d                   	pop    %ebp
    134c:	c3                   	ret    
      prevp->s.ptr = p->s.ptr;
    134d:	8b 03                	mov    (%ebx),%eax
    134f:	89 07                	mov    %eax,(%edi)
    1351:	eb e9                	jmp    133c <malloc_wf+0xcc>
