 ...
 229:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
{
 ...
 245:	50                   	push   %eax
 246:	8d 81 40 10 00 00    	lea    0x1040(%ecx),%eax
 24c:	50                   	push   %eax
 ...
 263:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
    p = buf;
 266:	bb 40 10 00 00       	mov    $0x1040,%ebx
    buf[m] = '\0';
 26b:	c6 81 40 10 00 00 00 	movb   $0x0,0x1040(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2ce:	eb a8                	jmp    278 <grep+0x58>
    if(p == buf)
 2d0:	81 fb 40 10 00 00    	cmp    $0x1040,%ebx
 ...
 2e5:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2e8:	2d 40 10 00 00       	sub    $0x1040,%eax
 2ed:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2ef:	51                   	push   %ecx
 2f0:	53                   	push   %ebx
 2f1:	68 40 10 00 00       	push   $0x1040
      m -= p - buf;
 ...
 63c:	89 d1                	mov    %edx,%ecx
{
 ...
 669:	0f b6 92 e4 0b 00 00 	movzbl 0xbe4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 864:	eb 1a                	jmp    880 <printf+0x1a0>
          s = "(null)";
 866:	bb da 0b 00 00       	mov    $0xbda,%ebx
        while(*s != 0){
...
print_free_list(){
 ...
 8b4:	83 ec 0c             	sub    $0xc,%esp
  Header* p;
  printf(1, "Header -> ");
 8b7:	68 f5 0b 00 00       	push   $0xbf5
 8bc:	6a 01                	push   $0x1
 8be:	e8 1d fe ff ff       	call   6e0 <printf>
  if(freep == 0){ 
 8c3:	a1 20 10 00 00       	mov    0x1020,%eax
 8c8:	83 c4 10             	add    $0x10,%esp
 8cb:	85 c0                	test   %eax,%eax
 8cd:	74 30                	je     8ff <print_free_list+0x4f>
    printf(1, "NULL\n");
    return;
  }
  for(p = base.s.ptr; p != &base; p = p->s.ptr){
 8cf:	8b 1d 24 10 00 00    	mov    0x1024,%ebx
 8d5:	81 fb 24 10 00 00    	cmp    $0x1024,%ebx
 8db:	74 22                	je     8ff <print_free_list+0x4f>
 8dd:	8d 76 00             	lea    0x0(%esi),%esi
    printf(1, "%d -> ", p->s.size);
 8e0:	83 ec 04             	sub    $0x4,%esp
 8e3:	ff 73 04             	pushl  0x4(%ebx)
 8e6:	68 06 0c 00 00       	push   $0xc06
 8eb:	6a 01                	push   $0x1
 8ed:	e8 ee fd ff ff       	call   6e0 <printf>
  for(p = base.s.ptr; p != &base; p = p->s.ptr){
 8f2:	8b 1b                	mov    (%ebx),%ebx
 8f4:	83 c4 10             	add    $0x10,%esp
 8f7:	81 fb 24 10 00 00    	cmp    $0x1024,%ebx
 8fd:	75 e1                	jne    8e0 <print_free_list+0x30>
    printf(1, "NULL\n");
 8ff:	83 ec 08             	sub    $0x8,%esp
 902:	68 00 0c 00 00       	push   $0xc00
 907:	6a 01                	push   $0x1
 909:	e8 d2 fd ff ff       	call   6e0 <printf>
  }
  printf(1, "NULL\n");
}
...
free(void *ap)
{
 ...
 921:	a1 20 10 00 00       	mov    0x1020,%eax
{
 ...
 946:	73 10                	jae    958 <free+0x38>
{
 ...
 971:	5b                   	pop    %ebx
  freep = p;
 972:	a3 20 10 00 00       	mov    %eax,0x1020
}
 977:	5e                   	pop    %esi
 978:	5f                   	pop    %edi
 979:	5d                   	pop    %ebp
 ...
 997:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 99a:	a3 20 10 00 00       	mov    %eax,0x1020
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 9bc:	3d 00 10 00 00       	cmp    $0x1000,%eax
 9c1:	0f 43 d8             	cmovae %eax,%ebx
  char *p;
  Header *hp;
 ...
 9c4:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 9cb:	50                   	push   %eax
 9cc:	e8 3a fc ff ff       	call   60b <sbrk>
  if(p == (char*)-1)
 9d1:	83 c4 10             	add    $0x10,%esp
 9d4:	83 f8 ff             	cmp    $0xffffffff,%eax
 9d7:	74 1f                	je     9f8 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 9e2:	50                   	push   %eax
 9e3:	e8 38 ff ff ff       	call   920 <free>
  return freep;
 9e8:	a1 20 10 00 00       	mov    0x1020,%eax
}
...
malloc(uint nbytes)
{
 a00:	55                   	push   %ebp
  ...
  if((prevp = freep) == 0){
 a01:	8b 0d 20 10 00 00    	mov    0x1020,%ecx
{
 ...
 a0a:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 a19:	74 65                	je     a80 <malloc+0x80>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a1b:	8b 01                	mov    (%ecx),%eax
    if(p->s.size >= nunits){
 a1d:	8b 50 04             	mov    0x4(%eax),%edx
 a20:	39 d3                	cmp    %edx,%ebx
 a22:	77 1d                	ja     a41 <malloc+0x41>
 a24:	eb 2e                	jmp    a54 <malloc+0x54>
 a26:	8d 76 00             	lea    0x0(%esi),%esi
 a29:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a30:	8b 30                	mov    (%eax),%esi
    if(p->s.size >= nunits){
 a32:	8b 56 04             	mov    0x4(%esi),%edx
 a35:	39 da                	cmp    %ebx,%edx
 a37:	73 27                	jae    a60 <malloc+0x60>
 a39:	8b 0d 20 10 00 00    	mov    0x1020,%ecx
 a3f:	89 f0                	mov    %esi,%eax
    ...
    if(p == freep)
 a41:	39 c1                	cmp    %eax,%ecx
 a43:	75 eb                	jne    a30 <malloc+0x30>
      if((p = morecore(nunits)) == 0)
 a45:	89 d8                	mov    %ebx,%eax
 a47:	e8 64 ff ff ff       	call   9b0 <morecore>
 a4c:	85 c0                	test   %eax,%eax
 a4e:	75 e0                	jne    a30 <malloc+0x30>
        return 0;
  }
}
 a50:	5b                   	pop    %ebx
 ...
 a53:	c3                   	ret    
    if(p->s.size >= nunits){
 a54:	89 c6                	mov    %eax,%esi
 a56:	89 c8                	mov    %ecx,%eax
 a58:	90                   	nop
 a59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
 a60:	39 d3                	cmp    %edx,%ebx
 a62:	74 4c                	je     ab0 <malloc+0xb0>
        p->s.size -= nunits;
 a64:	29 da                	sub    %ebx,%edx
 a66:	89 56 04             	mov    %edx,0x4(%esi)
        p += p->s.size;
 a69:	8d 34 d6             	lea    (%esi,%edx,8),%esi
        p->s.size = nunits;
 a6c:	89 5e 04             	mov    %ebx,0x4(%esi)
}
 a6f:	5b                   	pop    %ebx
      freep = prevp;
 a70:	a3 20 10 00 00       	mov    %eax,0x1020
      return (void*)(p + 1);
 a75:	8d 46 08             	lea    0x8(%esi),%eax
}
 a78:	5e                   	pop    %esi
 a79:	5d                   	pop    %ebp
 a7a:	c3                   	ret    
 ...
 a7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a80:	c7 05 20 10 00 00 24 	movl   $0x1024,0x1020
 a87:	10 00 00 
    base.s.size = 0;
 a8a:	b9 24 10 00 00       	mov    $0x1024,%ecx
    base.s.ptr = freep = prevp = &base;
 a8f:	c7 05 24 10 00 00 24 	movl   $0x1024,0x1024
 a96:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a99:	89 c8                	mov    %ecx,%eax
    base.s.size = 0;
 a9b:	c7 05 28 10 00 00 00 	movl   $0x0,0x1028
 aa2:	00 00 00 
    if(p->s.size >= nunits){
 aa5:	eb 9a                	jmp    a41 <malloc+0x41>
 aa7:	89 f6                	mov    %esi,%esi
 aa9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        prevp->s.ptr = p->s.ptr;
 ab0:	8b 16                	mov    (%esi),%edx
 ab2:	89 10                	mov    %edx,(%eax)
 ab4:	eb b9                	jmp    a6f <malloc+0x6f>
...
malloc_wf(uint nbytes)
{
 ...
 acc:	83 c0 07             	add    $0x7,%eax
 acf:	c1 e8 03             	shr    $0x3,%eax
 ...
 ad9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((prevp = freep) == 0){
 ae0:	8b 1d 20 10 00 00    	mov    0x1020,%ebx
 ae6:	85 db                	test   %ebx,%ebx
 ae8:	74 66                	je     b50 <malloc_wf+0x90>
 aea:	8b 03                	mov    (%ebx),%eax
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  ...
  maxp = 0;
  maxprevp = 0;
 aec:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  if((prevp = freep) == 0){
 af3:	89 df                	mov    %ebx,%edi
  uint max = 0;
 af5:	31 f6                	xor    %esi,%esi
  maxp = 0;
 af7:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
 afe:	8b 50 04             	mov    0x4(%eax),%edx
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 b01:	eb 12                	jmp    b15 <malloc_wf+0x55>
 b03:	90                   	nop
 b04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 b08:	39 d8                	cmp    %ebx,%eax
 b0a:	74 24                	je     b30 <malloc_wf+0x70>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 b0c:	8b 08                	mov    (%eax),%ecx
    if(p->s.size >= nunits && p->s.size > max){
 b0e:	89 c7                	mov    %eax,%edi
 b10:	8b 51 04             	mov    0x4(%ecx),%edx
 b13:	89 c8                	mov    %ecx,%eax
 b15:	39 d6                	cmp    %edx,%esi
 b17:	73 ef                	jae    b08 <malloc_wf+0x48>
 b19:	39 55 e4             	cmp    %edx,-0x1c(%ebp)
 b1c:	77 ea                	ja     b08 <malloc_wf+0x48>
    if(p == freep)
 b1e:	39 d8                	cmp    %ebx,%eax
 b20:	74 57                	je     b79 <malloc_wf+0xb9>
 b22:	89 7d dc             	mov    %edi,-0x24(%ebp)
 b25:	89 d6                	mov    %edx,%esi
 b27:	89 45 e0             	mov    %eax,-0x20(%ebp)
 b2a:	eb e0                	jmp    b0c <malloc_wf+0x4c>
 ...
 b35:	75 39                	jne    b70 <malloc_wf+0xb0>
      p->s.size = nunits;
    }
    freep = prevp;
    return (void*)(p + 1);
 ...
 b3a:	e8 71 fe ff ff       	call   9b0 <morecore>
 b3f:	85 c0                	test   %eax,%eax
 b41:	75 9d                	jne    ae0 <malloc_wf+0x20>
      return 0;
    return malloc_wf(nbytes);
  }
 b43:	83 c4 1c             	add    $0x1c,%esp
 b46:	5b                   	pop    %ebx
 b47:	5e                   	pop    %esi
 b48:	5f                   	pop    %edi
 b49:	5d                   	pop    %ebp
 ...
 b57:	10 00 00 
 b5a:	c7 05 24 10 00 00 24 	movl   $0x1024,0x1024
 b61:	10 00 00 
    base.s.size = 0;
 b64:	c7 05 28 10 00 00 00 	movl   $0x0,0x1028
 b6b:	00 00 00 
  if(maxp != 0){
 b6e:	eb c7                	jmp    b37 <malloc_wf+0x77>
 b70:	8b 5d e0             	mov    -0x20(%ebp),%ebx
 b73:	8b 7d dc             	mov    -0x24(%ebp),%edi
 b76:	8b 53 04             	mov    0x4(%ebx),%edx
    if(p->s.size == nunits){
 b79:	39 55 e4             	cmp    %edx,-0x1c(%ebp)
 b7c:	74 1f                	je     b9d <malloc_wf+0xdd>
      p->s.size -= nunits;
 b7e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 b81:	29 c2                	sub    %eax,%edx
 b83:	89 53 04             	mov    %edx,0x4(%ebx)
      p = p + p->s.size;
 b86:	8d 1c d3             	lea    (%ebx,%edx,8),%ebx
      p->s.size = nunits;
 b89:	89 43 04             	mov    %eax,0x4(%ebx)
    freep = prevp;
 b8c:	89 3d 20 10 00 00    	mov    %edi,0x1020
 b92:	83 c4 1c             	add    $0x1c,%esp
    return (void*)(p + 1);
 b95:	8d 43 08             	lea    0x8(%ebx),%eax
 b98:	5b                   	pop    %ebx
 b99:	5e                   	pop    %esi
 b9a:	5f                   	pop    %edi
 b9b:	5d                   	pop    %ebp
 b9c:	c3                   	ret    
      prevp->s.ptr = p->s.ptr;
 b9d:	8b 03                	mov    (%ebx),%eax
 b9f:	89 07                	mov    %eax,(%edi)
 ba1:	eb e9                	jmp    b8c <malloc_wf+0xcc>
