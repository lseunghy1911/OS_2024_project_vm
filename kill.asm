 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 f0 08 00 00 	movzbl 0x8f0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 594:	eb 1a                	jmp    5b0 <printf+0x1a0>
          s = "(null)";
 596:	bb e8 08 00 00       	mov    $0x8e8,%ebx
        while(*s != 0){
...
print_free_list(){
 ...
 5e4:	83 ec 0c             	sub    $0xc,%esp
  Header* p;
  printf(1, "Header -> ");
 5e7:	68 01 09 00 00       	push   $0x901
 5ec:	6a 01                	push   $0x1
 5ee:	e8 1d fe ff ff       	call   410 <printf>
  if(freep == 0){ 
 5f3:	a1 40 0c 00 00       	mov    0xc40,%eax
...
free(void *ap)
{
 ...
 651:	a1 40 0c 00 00       	mov    0xc40,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 40 0c 00 00       	mov    %eax,0xc40
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 40 0c 00 00       	mov    %eax,0xc40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 730:	55                   	push   %ebp
  ...
  if((prevp = freep) == 0){
 731:	8b 0d 40 0c 00 00    	mov    0xc40,%ecx
{
 ...
 73a:	8b 45 08             	mov    0x8(%ebp),%eax
{
 ...
 769:	8b 0d 40 0c 00 00    	mov    0xc40,%ecx
 ...
 79f:	5b                   	pop    %ebx
      freep = prevp;
 7a0:	a3 40 0c 00 00       	mov    %eax,0xc40
      return (void*)(p + 1);
 ...
 7ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 40 0c 00 00 44 	movl   $0xc44,0xc40
 7b7:	0c 00 00 
    base.s.size = 0;
 7ba:	b9 44 0c 00 00       	mov    $0xc44,%ecx
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 44 0c 00 00 44 	movl   $0xc44,0xc44
 7c6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 c8                	mov    %ecx,%eax
    base.s.size = 0;
 7cb:	c7 05 48 0c 00 00 00 	movl   $0x0,0xc48
 7d2:	00 00 00 
    if(p->s.size >= nunits){
...
malloc_wf(uint nbytes)
{
 ...
 809:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((prevp = freep) == 0){
 810:	8b 1d 40 0c 00 00    	mov    0xc40,%ebx
 ...
 887:	0c 00 00 
 88a:	c7 05 44 0c 00 00 44 	movl   $0xc44,0xc44
 891:	0c 00 00 
    base.s.size = 0;
 894:	c7 05 48 0c 00 00 00 	movl   $0x0,0xc48
 89b:	00 00 00 
  if(maxp != 0){
 ...
 8b9:	89 43 04             	mov    %eax,0x4(%ebx)
    freep = prevp;
 8bc:	89 3d 40 0c 00 00    	mov    %edi,0xc40
