...
main(void)
{
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 08 0d 00 00       	push   $0xd08
  ab:	68 92 09 00 00       	push   $0x992
  b0:	e8 c6 02 00 00       	call   37b <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 95 09 00 00       	push   $0x995
  bc:	6a 01                	push   $0x1
  ...
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 64 09 00 00       	push   $0x964
  d2:	e8 b4 02 00 00       	call   38b <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 64 09 00 00       	push   $0x964
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 bc 09 00 00 	movzbl 0x9bc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb b4 09 00 00       	mov    $0x9b4,%ebx
        while(*s != 0){
...
print_free_list(){
 ...
 674:	83 ec 0c             	sub    $0xc,%esp
  Header* p;
  printf(1, "Header -> ");
 677:	68 cd 09 00 00       	push   $0x9cd
 67c:	6a 01                	push   $0x1
 67e:	e8 1d fe ff ff       	call   4a0 <printf>
  if(freep == 0){ 
 683:	a1 10 0d 00 00       	mov    0xd10,%eax
 688:	83 c4 10             	add    $0x10,%esp
 68b:	85 c0                	test   %eax,%eax
 68d:	74 30                	je     6bf <print_free_list+0x4f>
    printf(1, "NULL\n");
    return;
  }
  for(p = base.s.ptr; p != &base; p = p->s.ptr){
 68f:	8b 1d 14 0d 00 00    	mov    0xd14,%ebx
 695:	81 fb 14 0d 00 00    	cmp    $0xd14,%ebx
 69b:	74 22                	je     6bf <print_free_list+0x4f>
 69d:	8d 76 00             	lea    0x0(%esi),%esi
    printf(1, "%d -> ", p->s.size);
 6a0:	83 ec 04             	sub    $0x4,%esp
 6a3:	ff 73 04             	pushl  0x4(%ebx)
 6a6:	68 de 09 00 00       	push   $0x9de
 6ab:	6a 01                	push   $0x1
 6ad:	e8 ee fd ff ff       	call   4a0 <printf>
  for(p = base.s.ptr; p != &base; p = p->s.ptr){
 6b2:	8b 1b                	mov    (%ebx),%ebx
 6b4:	83 c4 10             	add    $0x10,%esp
 6b7:	81 fb 14 0d 00 00    	cmp    $0xd14,%ebx
 6bd:	75 e1                	jne    6a0 <print_free_list+0x30>
    printf(1, "NULL\n");
 6bf:	83 ec 08             	sub    $0x8,%esp
 6c2:	68 d8 09 00 00       	push   $0x9d8
 6c7:	6a 01                	push   $0x1
 6c9:	e8 d2 fd ff ff       	call   4a0 <printf>
  }
  printf(1, "NULL\n");
}
...
free(void *ap)
{
 ...
 6e1:	a1 10 0d 00 00       	mov    0xd10,%eax
{
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	a3 10 0d 00 00       	mov    %eax,0xd10
}
 737:	5e                   	pop    %esi
 738:	5f                   	pop    %edi
 739:	5d                   	pop    %ebp
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 10 0d 00 00       	mov    %eax,0xd10
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 773:	53                   	push   %ebx
 774:	bb 00 10 00 00       	mov    $0x1000,%ebx
 779:	83 ec 10             	sub    $0x10,%esp
 77c:	3d 00 10 00 00       	cmp    $0x1000,%eax
 781:	0f 43 d8             	cmovae %eax,%ebx
  char *p;
  Header *hp;
 ...
 784:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 78b:	50                   	push   %eax
 78c:	e8 3a fc ff ff       	call   3cb <sbrk>
  if(p == (char*)-1)
 791:	83 c4 10             	add    $0x10,%esp
 794:	83 f8 ff             	cmp    $0xffffffff,%eax
 797:	74 1f                	je     7b8 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 799:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
 79c:	83 ec 0c             	sub    $0xc,%esp
 79f:	83 c0 08             	add    $0x8,%eax
 7a2:	50                   	push   %eax
 7a3:	e8 38 ff ff ff       	call   6e0 <free>
  return freep;
 7a8:	a1 10 0d 00 00       	mov    0xd10,%eax
}
...
malloc(uint nbytes)
{
 7c0:	55                   	push   %ebp
  ...
  if((prevp = freep) == 0){
 7c1:	8b 0d 10 0d 00 00    	mov    0xd10,%ecx
{
 ...
 7ca:	8b 45 08             	mov    0x8(%ebp),%eax
{
 7cd:	53                   	push   %ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 7ce:	8d 58 07             	lea    0x7(%eax),%ebx
 7d1:	c1 eb 03             	shr    $0x3,%ebx
 7d4:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 7d7:	85 c9                	test   %ecx,%ecx
 7d9:	74 65                	je     840 <malloc+0x80>
 ...
 7e0:	39 d3                	cmp    %edx,%ebx
 7e2:	77 1d                	ja     801 <malloc+0x41>
 7e4:	eb 2e                	jmp    814 <malloc+0x54>
 7e6:	8d 76 00             	lea    0x0(%esi),%esi
 7e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f0:	8b 30                	mov    (%eax),%esi
    if(p->s.size >= nunits){
 7f2:	8b 56 04             	mov    0x4(%esi),%edx
 7f5:	39 da                	cmp    %ebx,%edx
 7f7:	73 27                	jae    820 <malloc+0x60>
 7f9:	8b 0d 10 0d 00 00    	mov    0xd10,%ecx
 7ff:	89 f0                	mov    %esi,%eax
    ...
    if(p == freep)
 801:	39 c1                	cmp    %eax,%ecx
 803:	75 eb                	jne    7f0 <malloc+0x30>
      if((p = morecore(nunits)) == 0)
 805:	89 d8                	mov    %ebx,%eax
 807:	e8 64 ff ff ff       	call   770 <morecore>
 80c:	85 c0                	test   %eax,%eax
 80e:	75 e0                	jne    7f0 <malloc+0x30>
        return 0;
  }
}
 810:	5b                   	pop    %ebx
 ...
 819:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
 820:	39 d3                	cmp    %edx,%ebx
 822:	74 4c                	je     870 <malloc+0xb0>
        p->s.size -= nunits;
 824:	29 da                	sub    %ebx,%edx
 826:	89 56 04             	mov    %edx,0x4(%esi)
        p += p->s.size;
 829:	8d 34 d6             	lea    (%esi,%edx,8),%esi
        p->s.size = nunits;
 82c:	89 5e 04             	mov    %ebx,0x4(%esi)
}
 82f:	5b                   	pop    %ebx
      freep = prevp;
 830:	a3 10 0d 00 00       	mov    %eax,0xd10
      return (void*)(p + 1);
 835:	8d 46 08             	lea    0x8(%esi),%eax
}
 838:	5e                   	pop    %esi
 839:	5d                   	pop    %ebp
 83a:	c3                   	ret    
 ...
 83c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 10 0d 00 00 14 	movl   $0xd14,0xd10
 847:	0d 00 00 
    base.s.size = 0;
 84a:	b9 14 0d 00 00       	mov    $0xd14,%ecx
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 14 0d 00 00 14 	movl   $0xd14,0xd14
 856:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 c8                	mov    %ecx,%eax
    base.s.size = 0;
 85b:	c7 05 18 0d 00 00 00 	movl   $0x0,0xd18
 862:	00 00 00 
    if(p->s.size >= nunits){
 865:	eb 9a                	jmp    801 <malloc+0x41>
 867:	89 f6                	mov    %esi,%esi
 869:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        prevp->s.ptr = p->s.ptr;
 870:	8b 16                	mov    (%esi),%edx
 872:	89 10                	mov    %edx,(%eax)
 874:	eb b9                	jmp    82f <malloc+0x6f>
...
malloc_wf(uint nbytes)
{
 ...
 899:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((prevp = freep) == 0){
 8a0:	8b 1d 10 0d 00 00    	mov    0xd10,%ebx
 8a6:	85 db                	test   %ebx,%ebx
 8a8:	74 66                	je     910 <malloc_wf+0x90>
 8aa:	8b 03                	mov    (%ebx),%eax
  ...
  maxp = 0;
  maxprevp = 0;
 8ac:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  if((prevp = freep) == 0){
 8b3:	89 df                	mov    %ebx,%edi
  uint max = 0;
 8b5:	31 f6                	xor    %esi,%esi
  maxp = 0;
 8b7:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
 8be:	8b 50 04             	mov    0x4(%eax),%edx
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c1:	eb 12                	jmp    8d5 <malloc_wf+0x55>
 8c3:	90                   	nop
 8c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 8c8:	39 d8                	cmp    %ebx,%eax
 8ca:	74 24                	je     8f0 <malloc_wf+0x70>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8cc:	8b 08                	mov    (%eax),%ecx
    if(p->s.size >= nunits && p->s.size > max){
 8ce:	89 c7                	mov    %eax,%edi
 8d0:	8b 51 04             	mov    0x4(%ecx),%edx
 8d3:	89 c8                	mov    %ecx,%eax
 8d5:	39 d6                	cmp    %edx,%esi
 8d7:	73 ef                	jae    8c8 <malloc_wf+0x48>
 8d9:	39 55 e4             	cmp    %edx,-0x1c(%ebp)
 8dc:	77 ea                	ja     8c8 <malloc_wf+0x48>
    if(p == freep)
 8de:	39 d8                	cmp    %ebx,%eax
 8e0:	74 57                	je     939 <malloc_wf+0xb9>
 8e2:	89 7d dc             	mov    %edi,-0x24(%ebp)
 8e5:	89 d6                	mov    %edx,%esi
 8e7:	89 45 e0             	mov    %eax,-0x20(%ebp)
 8ea:	eb e0                	jmp    8cc <malloc_wf+0x4c>
 8ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      break;
  }

  if(maxp != 0){
 8f0:	8b 45 e0             	mov    -0x20(%ebp),%eax
 8f3:	85 c0                	test   %eax,%eax
 8f5:	75 39                	jne    930 <malloc_wf+0xb0>
      p->s.size = nunits;
    }
    freep = prevp;
    return (void*)(p + 1);
 ...
 8fa:	e8 71 fe ff ff       	call   770 <morecore>
 8ff:	85 c0                	test   %eax,%eax
 901:	75 9d                	jne    8a0 <malloc_wf+0x20>
      return 0;
 ...
 90c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 910:	c7 05 10 0d 00 00 14 	movl   $0xd14,0xd10
 917:	0d 00 00 
 91a:	c7 05 14 0d 00 00 14 	movl   $0xd14,0xd14
 921:	0d 00 00 
    base.s.size = 0;
 924:	c7 05 18 0d 00 00 00 	movl   $0x0,0xd18
 92b:	00 00 00 
  if(maxp != 0){
 92e:	eb c7                	jmp    8f7 <malloc_wf+0x77>
 930:	8b 5d e0             	mov    -0x20(%ebp),%ebx
 933:	8b 7d dc             	mov    -0x24(%ebp),%edi
 936:	8b 53 04             	mov    0x4(%ebx),%edx
    if(p->s.size == nunits){
 939:	39 55 e4             	cmp    %edx,-0x1c(%ebp)
 93c:	74 1f                	je     95d <malloc_wf+0xdd>
      p->s.size -= nunits;
 93e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 941:	29 c2                	sub    %eax,%edx
 943:	89 53 04             	mov    %edx,0x4(%ebx)
      p = p + p->s.size;
 946:	8d 1c d3             	lea    (%ebx,%edx,8),%ebx
      p->s.size = nunits;
 949:	89 43 04             	mov    %eax,0x4(%ebx)
    freep = prevp;
 94c:	89 3d 10 0d 00 00    	mov    %edi,0xd10
 952:	83 c4 1c             	add    $0x1c,%esp
    return (void*)(p + 1);
 955:	8d 43 08             	lea    0x8(%ebx),%eax
 958:	5b                   	pop    %ebx
 959:	5e                   	pop    %esi
 95a:	5f                   	pop    %edi
 95b:	5d                   	pop    %ebp
 95c:	c3                   	ret    
      prevp->s.ptr = p->s.ptr;
 95d:	8b 03                	mov    (%ebx),%eax
 95f:	89 07                	mov    %eax,(%edi)
 961:	eb e9                	jmp    94c <malloc_wf+0xcc>
